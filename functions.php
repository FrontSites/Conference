    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            <table class="form-table">
                ...
                <tr>
                    <th scope="row">Стара ціна (VIP)</th>
                    <td>
...
// Очищаем админ-страницу таймера до нужного минимума
// (оставляем только флаги, дату/время и цены REGULAR/VIP)
// Лишние разделы не добавляются в эту страницу, поэтому дополнительных правок тут не требуется.
