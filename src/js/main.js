...
function initLocationMap() {
  ...
  const infowindow = new google.maps.InfoWindow({
    content: `
      <div style="padding: 10px; max-width: 250px; font-family: 'Manrope', sans-serif;">
        <div style="display: flex; align-items: center; margin-bottom: 6px;">
          <img src="${window.location.origin}/wp-content/themes/conference/assets/images/pin.svg" 
               style="width: 25px; height: 25px; margin-right: 8px;" alt="Pin">
          <span style="font-weight: 700; font-size: 14px; color: #333; text-transform: uppercase;">FULLSET</span>
        </div>
        <div style="text-align: left;">
          <h3 style="margin: 0 0 4px 0; color: #333; font-size: 13px; font-weight: 600; text-align: left;">${
            isEnglish
              ? "Parkovy Congress and Exhibition Center"
              : "Парковий Конгресно-виставковий центр"
          }</h3>
          <p style="margin: 0; color: #666; font-size: 11px; text-align: left;">${
